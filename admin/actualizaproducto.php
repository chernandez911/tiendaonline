...
<div class="container">
<p style="font-size:32px; font-family:Aubrey;"> Productos Registrados</p>
</div>
<?php
...
echo'					>'.$digaestado.'</td>
						<td><a href="actualizarproducto.php?id='.$consulta->fields['id'].'"><button>Actualizar Producto</button> </a> <br>
