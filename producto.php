...
echo"		<div id='tabs'>
			...
			Comprar:
				<input type='number' class='btn btn-default' value='1' max='10' min='1' id='numero".$consulta->fields['id']."'>
			</div>
			<div id='tabs-1'>
...
echo'		 <img src="photo/'.$consulta2->fields['imagen'].'" width=250px class="img-rounded">	';
$consulta2->moveNext();
}
echo"		</div> ";
echo"		<div id='tabs-4'>
